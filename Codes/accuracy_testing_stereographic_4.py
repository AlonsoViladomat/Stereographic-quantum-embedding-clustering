...
#stores results in a file
out_folder = os.path.join(cwd+ "/results/stopping_criteria/actual_stereographic_sim_random_choice_not_new_update")
try:
    os.mkdir(out_folder)
except FileExistsError:
    pass
...
output_file = "3D_stereograpic_stopping_criteria_expt_" + string
