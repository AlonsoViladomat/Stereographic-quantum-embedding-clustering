    ...
    for r in radii:
        ...
        for iterator1 in range(100):
            for iterator2 in range(100):
                ...
                #dataClusters= np.asarray(dataClusters,dtype=int)
                #print(type(dataClusters[5]))
                #print(type(sampleLabelsIn[5]))
            ...
            output_file = string + "_results_classical" + '_stereographic_random_choice_robertoMod'
