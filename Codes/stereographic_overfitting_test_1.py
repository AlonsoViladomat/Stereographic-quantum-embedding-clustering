...
num_point = [640,1280,2560,3200,6400,12800,25600,51200] #8
radii = [0.01,0.1,0.25,0.5,1,1.25,1.5,1.75,2,2.5,3,4,5,10,100] #15
...
#stores results in a file
out_folder = os.path.join(cwd+ "/results/overfitting/stereographic_sim_random_choice")
try:
    os.mkdir(out_folder)
except FileExistsError:
    pass
    ...
    for r in radii:
        ...
        for iterator1 in range(100):
            ...
            for iterator2 in range(100):
                ...
                dataClusters_train, centroids_train, numIter_train = classical_k_mean(64,tx_init_pt,tx_alph,50)
                ...
                dataClusters_test, centroids_test, numIter_test = classical_k_mean(64,tx_init_pt,centroids_train[:,[0,1,2]],1)
...
output_file = "overfitting_stereographic_results" + string
