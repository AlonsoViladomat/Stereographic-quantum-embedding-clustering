...
#stores results in a file
out_folder = os.path.join(cwd+ "/results/stereographic_sim_new_update")
try:
    os.mkdir(out_folder)
except FileExistsError:
    pass
...
#stores results in a file
out_folder = os.path.join(cwd+ "/results/stereographic_sim_new_update/classical_with_time")
try:
    os.mkdir(out_folder)
except FileExistsError:
    pass
    ...
    for r in radii:
        ...
        for iterator1 in range(100):
            ...
            for iterator2 in range(100):
                ...
                dataClusters, centroids, numIter = classical_k_mean(64,tx_init_pt,tx_alph,50,r)
...
output_file = "Results_stereographic_classical_new_update_" + string
