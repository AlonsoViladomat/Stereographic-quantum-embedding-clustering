...
from functions_3D_stereographic_stopping_criteria import *
...
#stores results in a file
out_folder = os.path.join(cwd+ "/results/stopping_criteria/short")
try:
    os.mkdir(out_folder)
except FileExistsError:
    pass
...
#stores results in a file
out_folder = os.path.join(cwd+ "/results/stopping_criteria/short/actual_stereographic_sim_random_choice_not_new_update")
try:
    os.mkdir(out_folder)
except FileExistsError:
    pass
...
for num_points in num_point:
    ...
    for r in radii:
        ...
        for iterator2 in range(100):
            ...
            dataClusters, centroids, numIter, accuracy, cluster_change = classical_k_mean(64,tx_init_pt,tx_alph,maxNumIter,sampleLabelsIn)
...
output_file = "3D_stereograpic_stopping_criteria_expt_SHORT_" + string
